...
def main():
    ...
    if not tasklists:
        ...
        print(
            "   Задачи будут создаваться в календаре пользователя, к которому есть доступ\n"
        )
    else:
    ...
    if not created_task:
        ...
        try:
            ...
            print(
                f"   https://console.cloud.google.com/apis/library/tasks.googleapis.com?project={project_id}"
            )
        except Exception:
            print(
